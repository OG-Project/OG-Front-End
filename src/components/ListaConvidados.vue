    ...
    <div class="convites-bg flex-col w-full bg-[#FEFBFF] shadow-md  shadow-gray-200 overflow-y-auto scrollbar-thin"
      ...
      <div class="flex items-center flex-col ml-5">
        <div class="w-full flex items-center mt-5 mb-2" v-for="convidado in listaConvidados" :key="convidado.nome"
          ...
          <div v-if="listaConvidados.length > 0">
            <img class="imgDePerfil" :src="caminhoDaImagemPerfil" :style="altDaImagemPerfil" />

          </div>

          <h2
            class="nome-convidado w-[4vw] md:text-sm xl:text-lg 2xl:mx-2 2xl:ml-2 xl:mx-10 xl:ml-2 lg:mx-3 lg:ml-2 md:ml-3 md:mx-1">
            {{ truncarNome(convidado.nome, 15) }}</h2>
...
.imgIcon {
  @apply bg-cover bg-center flex flex-col justify-center items-center 2xl:mr-[1vw] 2xl:ml-[2vw] xl:mr-[-2vw] xl:ml-[3vw] lg:mr-[-4vw] lg:ml-[4vw] md:mr-[-6vw] md:ml-[6vw] 2xl:w-[2vw] 2xl:h-[3vh] xl:w-[2.5vw] xl:h-[4vh] lg:w-[3vw] lg:h-[5vh] md:w-[4vw] md:h-[6vh];
}

.imgDePerfil {
  @apply rounded-full bg-cover bg-center flex justify-center flex-col 2xl:ml-2 xl:ml-10 lg:ml-8 md:ml-[-1.5vw] 2xl:w-[3vw] 2xl:h-[5vh] xl:w-[3vw] xl:h-[6vh] lg:w-[4vw] lg:h-[8vh] md:w-[5vw] md:h-[10vh];
}

.selectEdit {
  @apply text-xs 2xl:ml-[0vw] xl:ml-[4vw] lg:ml-[6vw] md:ml-[8vw] mb-[10px] mt-2 2xl:w-[5vw] 2xl:h-[5vh] xl:w-[8vw] xl:h-[4vw] lg:w-[10vw] lg:h-[5vw] md:w-[12vw] md:h-[6vw];
}
