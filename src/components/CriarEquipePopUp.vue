        ...
        <div class="divGeral">
            ...
            <div class=" grid-template  flex w-full mt-[1vh]  p-5">
                ...
                <Input :class="{ 'computedClasses': someCondition }" styleInput="input-transparente-claro"
                    :largura="larguraInput()" conteudoInput="Nome da Equipe" v-model="nome" :modelValue="nome"
                    @updateModelValue="(e) => {
                        nome = e
                    }">></Input>
            </div>
            <div class=" grid-template  flex w-full">
                <Input :class="{ 'computedClasses': someCondition }" styleInput="input-transparente-claro"
                    :largura="larguraInputConvidado()" icon="../src/imagem-vetores/adicionarPessoa.svg"
                    conteudoInput="Adicionar Membro" v-model="usuarioConvidado" :modelValue="usuarioConvidado"
                    @updateModelValue="(e) => {
                        usuarioConvidado = e
                    }"></Input>
            </div>
            ...
            <div class=" grid-template flex w-full mt-[1vh]">
                <textAreaPadrao
                    ...
                    v-model="descricao" :modelValue="descricao" @updateModelValue="(e) => {
                        descricao = e
                    }"></textAreaPadrao>
            </div>
            <div class="convidados-div flex justify-center xl:mt-[2vh] lg:mt-[4vh] md:mt-[4vh]">
                <ListaConvidados :margin-right="marginRightConvidado()" texto="Convites" mostrar-select="true"
