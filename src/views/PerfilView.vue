    ...
    <div class="flex justify-center">
        <div class="flex  flex-col items-center w-[443px] h-[877px] drop-shadow-md bg-[#FEFBFF]">
            ...
            <div class=" flex flex-col gap-10">    
                ...
                <Botao :funcaoClick="privacidade" preset="PadraoRoxo" texto="Privacidade" tamanhoDaBorda="2px" tamanhoDaFonte="2.0vh" />
                <Botao :funcaoClick="aparencia" preset="PadraoRoxo" texto="Aparência" tamanhoDaBorda="2px" tamanhoDaFonte="2.0vh" />
            </div>
        </div>
