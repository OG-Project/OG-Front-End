<template>
  ...
  <div id="bgBranco" class="flex flex-row min-h-[96%] w-full">
      ...
      <div class="pl-12 mt-4">
          ...
          <div class="w-[100%] border-2 mt-4 mb-4 shadow-lg min-h-[10vh] flex">
            ...
            <div class="pb-2 flex flex-col items-end">
              <TextAreaPadrao
                ...
                tamanho-da-fonte="1rem"
                resize="vertical"
                v-model="comentarioSendoEnviado.value"
              ></TextAreaPadrao>
              <Botao texto="Enviar" preset="PadraoRoxo" tamanhoPadrao="pequeno" :funcaoClick="enviaComentario" :parametrosFuncao="[comentarioSendoEnviado, usuario.nome, usuario.fotoDoAutor]"></Botao>
            </div>
          </div>
        </div>
        <div class="w-[85%] flex flex-col">
          <div
            ...
            class="w-[100%] border-2 mt-4 mb-4 shadow-lg min-h-[10vh] flex"
          >
            <img
    ...
    <div class="w-[40vw] min-h-[96%] flex flex-col">
      <div class="w-[80%] min-h-[80vh] shadow-2xl border-2">
        ...
        <div
          ...
          class="min-h-[96%] w-[100%] pt-4 flex flex-col gap-4 overflow-auto"
        >
          <div
    ...
    <div class="w-[20vw] h-[88vh] flex flex-col border-2 gap-8 overflow-auto">
...
function enviaComentario(comentario, nome, foto){
...
const Comentarios = ref([
  {
    autor: "Kanye West",
    conteudo:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi at felis vel neque suscipit consectetur quis efficitur ante. Fusce malesuada odio sit amet quam porttitor, vitae pharetra arcu pellentesque. Etiam ac aliquet lorem. Nulla vitae nisi id sem mollis sodales. Phasellus ac lorem pretium, tempus metus vitae, tincidunt nibh. Donec euismod, nibh nec mollis porta,ligula urna vehicula tellus, vel pharetra est lorem a augue.",
    fotoDoAutor:
      "data:image/jpeg;base64,",
  },
  {
